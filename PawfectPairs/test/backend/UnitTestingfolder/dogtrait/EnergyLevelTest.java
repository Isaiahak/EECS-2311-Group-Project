...
class EnergyLevelTest {
	 ...
	 @Test
	    public void testConstructorAndGetters() {
	        ...
	        assertEquals("Lazy", energyLevel.getName()); // Checks if the name is set correctly
	    ...
	    public void testToString() {
	        ...
	        assertEquals("Moderate", energyLevel.toString()); // Checks if toString() returns the correct name
	    }
