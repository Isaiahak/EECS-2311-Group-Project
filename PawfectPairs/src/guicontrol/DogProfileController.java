...
public class DogProfileController {
    ...
    private ArrayList<Dog> dogProfiles = new ArrayList<>(List.of(
    		...
    		new Dog("Charles", 1, 2, 1, 2, "M", new Poster(5, "doglover123", 12), false, "/guilayout/dog.png", "Charles is involed in some shady stuff. Don't ask questions you don't want to know the answers to."), 
    		new Dog("Sandy", 2, 3, 1, 2, "F", new Poster(5, "doglover123", 12), false,"/guilayout/dog1.png", "Sandy looks like she knows something you don't... but that's what makes her so loveable!"),
    		new Dog("Chuckles", 3, 8, 0, 0, "M", new Poster(5, "doglover123", 12), false,"/guilayout/dog4.png", "Lazy and old Chuckles is the perfect lap dog for anyone who doesn't like to move.")
